...
useHead({
    title: 'Блог - рецепты и статьи',
    meta: [
        {
            name: 'description',
            content: 'В нашем блоге — полезные рекомендации для профессиональных кондитеров, истории о мире кондитеров, секреты мастеров, рецепты и многое другое для специалистов.'
        }
    ],
    link: [
        {
