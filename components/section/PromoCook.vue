<template>
    ...
    <div class="overflow-hidden  py-32">
        ...
        <div class="mx-auto max-w-7xl  flex px-8 lg:px-6 lg:block">
            <!-- <div class="mx-auto max-w-7xl px-6 lg:flex lg:px-8"> -->

            <div class="mx-0  grid min-w-full max-w-none grid-cols-1 gap-x-12  gap-y-8

                        lg:mx-auto lg:max-w-2xl  lg:gap-y-16 
                ">
                <!-- <div
                ...
                <div class="col-end-1 w-full max-w-lg pb-8 lg:col-auto lg:w-auto lg:max-w-auto  lg:pb-auto ">
                    <!-- <div class="lg:col-end-1 lg:w-full lg:max-w-lg lg:pb-8"> -->

                    <h2 class="font-bold text-4xl 2xl:text-3xl">Кондитерам</h2>

                    <p class="mt-6 text-base leading-8 text-gray-600">Quasi est quaerat. Sit molestiae et. Provident ad
                    ...
                    <p class="mt-6 text-base leading-7 text-gray-600">Anim aute id magna aliqua ad ad non deserunt sunt.
                        Qui irure qui lorem cupidatat commodo. Elit sunt amet fugiat veniam occaecat fugiat. Quasi
                ...
                <div class="contents flex-wrap items-start justify-end gap-8 sm:gap-6 lg:flex">
                    <!-- <div class="flex flex-wrap items-start justify-end gap-6 sm:gap-8 lg:contents"> -->

                    <div class="w-auto  self-end ml-auto lg:flex-auto lg:w-0 lg:self-auto
                     ">
                    ...
                    <div
                        class=" gap-x-8 justify-end items-start w-[37rem] flex ml-auto col-end-2 col-span-2 lg:contents">
                        <!-- <div
