                    ...
                    <div class="p-4">
                        <div class="flex items-start">
                            <div class="flex-shrink-0">
                                <Icon v-show="toast.options.type === 'error'" name="material-symbols:warning-rounded" class="h-6 w-6 bg-red-500"/>
                                <Icon v-show="toast.options.type === 'success'" name="material-symbols:check-circle-rounded" class="h-6 w-6 bg-green-500"/>
                            </div>
