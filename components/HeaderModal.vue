            ...
            <nav class="flex items-center justify-between py-4 gap-x-12 xl:px-0  lg:flex-wrap lg:gap-y-4 xs:justify-center"
                ...
                <div class="flex items-center gap-x-12 2xl:gap-x-10 lg:w-full lg:order-1 xs:hidden">
                    <div class="flex gap-x-32 2xl:gap-x-12 lg:justify-between lg:w-full">
                        <button type="button" class="relative" @click="openCatalog = true">Каталог

                            <TransitionRoot as="template" :show="openCatalog">
                                <Dialog class="relative z-10" @close="openCatalog = false">
                                    <TransitionChild as="template" enter="ease-out duration-300" enter-from="opacity-0"
                                        enter-to="opacity-100" leave="ease-in duration-200" leave-from="opacity-100"
                                        leave-to="opacity-0">
                                            ...
                                            <DialogPanel
                                                ...
                                                <div>
                                                    ...
                                                    <div class="mt-3 text-center sm:mt-5">
                                                        ...
                                                        <div class="mt-2">
                                                            <p class="text-sm text-gray-500">Lorem ipsum, dolor sit
                                                                amet consectetur adipisicing elit. Eius aliquam
                                                                laudantium explicabo pariatur iste dolorem animi
                                                                vitae error totam. At sapiente aliquam accusamus
                                                                facere veritatis.</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div
                                                    ...
                                                    <button type="button"
                                                        ...
                                                        @click="openCatalog = false">Deactivate</button>
                                                    <button type="button"
